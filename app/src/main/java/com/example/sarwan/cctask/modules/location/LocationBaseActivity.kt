...
package com.example.sarwan.cctask.modules.location
...
abstract class LocationBaseActivity : BaseActivity() {
    ...
    * */
     ...
     */
    private var devicePermissionDenied = false
                ...
                when (statusCode) {
                    LocationSettingsStatusCodes.RESOLUTION_REQUIRED -> {
                        ...
                        try {
                            ...
                            rae.startResolutionForResult(this@LocationBaseActivity, REQUEST_CHECK_SETTINGS)
    ...
    public override fun onResume() {
        ...
        if (checkPermissions() && !mRequestingLocationUpdates && !devicePermissionDenied) {
        ...
        if (shouldProvideRationale) {
            ...
            showSnackBar(R.string.permission_rationale,
                android.R.string.ok, View.OnClickListener {
                    // Request permission
                    ActivityCompat.requestPermissions(this@LocationBaseActivity,
    ...
    companion object {
        ...
        private val TAG = LocationBaseActivity::class.java.simpleName
